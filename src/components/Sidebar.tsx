...
export function Sidebar() {
  ...
  return (
    <div className="w-72 border-r border-[#1f1f22] bg-[#0a0a0b] flex flex-col h-screen shrink-0">
      ...
      {/* Scrollable area: Navigation + File Manager */}
      <div className="flex-1 overflow-y-auto">
        ...
        {/* File Manager */}
        <div className="px-4 pt-3 pb-4 border-t border-[#1f1f22] mt-2">
          ...
          {loadedCount === 0 && (
            <div
              className="mt-3 border border-dashed border-zinc-700/50 rounded-xl p-3 cursor-pointer hover:border-electric/40 transition-colors"
              onClick={() => globalInputRef.current?.click()}
            >
